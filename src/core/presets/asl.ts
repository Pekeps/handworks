...
export const asl: Record<string, HandPose> = {
  ...
  S: {
    // thumb wraps across the FRONT of the curled fingers (fitted so the
    // raw pose already rests on the middle phalanges; the collision pass
    // only adds a whisper of lift)
    fingers: {
